...
public class SubscriptionServiceImpl implements SubscriptionService {
    ...
    @Override
    public void updateSubscription(String userId, String subscriptionId, Subscription subscription) {
        Query query = Query.query(Criteria.where("id").is(userId).and("subscriptions.id").is(subscriptionId));
